...
Search.prototype.query = function query(data) {
  ...
  if (data.hasOwnProperty('customer_id')) {
    ...
    if (data.hasOwnProperty('type')) {
      ...
      self.emit('error', { 'msg':  'No type defined.'});
      return false;
    }
    ...
    self.emit('error', { 'msg':  'No customer_id defined.'});
    return false;
  }

  // @TODO: Validate the search JSON request for safety reasons. Use ES's
  // validate API.
